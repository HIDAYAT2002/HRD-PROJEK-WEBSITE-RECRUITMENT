...
<?php
  // ✅ LOADER GANGSING (tanpa database)
  // Pastikan file ini ada di root: /career/loading.php
  // Pastikan logo ada di: /career/assets/img/evalube_logo.png
  $LOADER_LOGO = "assets/img/evalube_logo.png";
  $LOADER_TEXT = "Memuat Karier WGI...";
